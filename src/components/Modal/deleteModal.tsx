import {
  ...
  const DeleteModal: React.FC<DeleteModalProps> =({dialogOpen, setDialogOpen})=>{
    return(
  ...
  <CardHeader>
    <CardTitle className="mb-5 flex justify-center">Are you sure you want to delete this task?</CardTitle>
  </CardHeader>
